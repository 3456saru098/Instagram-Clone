    ...
    <div className="mt-8 space-y-8">
      ...
      {posts.map((eachPost, index) => (
        <div  key={index} className="space-y-2">
          ...
          <img
            className=" h-[79vh] w-full object-cover rounded-sm"
          ...
          <p>
            ...
            non hic dolores architecto explicabo beatae quaerat commodi
            laboriosam. Voluptas, accusamus.
          </p>
          <hr />
        </div>
      ))}
...
const posts = [
  {
    ...
    postPicture:
      "https://plus.unsplash.com/premium_photo-1690407617542-2f210cf20d7e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D",
    caption: "jwhdkwhedwge nsmjnxkdqjwhdiw",
  },
